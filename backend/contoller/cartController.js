...
//       console.log('Insufficient stock:', { productId, stock: product.stock, requested: quantity });
...
//     // Store the quantity being removed for stock update
...
//     } else {
//       console.log('Product not found for stock update:', productId);
//     }
...
//     // Store items for stock update before clearing
...
//     // Update stock for all items that were in the cart
//     for (const item of itemsToClear) {
//       const product = await Product.findById(item.productId);
//       if (product) {
//         product.stock += item.quantity;
//         await product.save();
//         console.log('Updated product stock after clear:', { productId: item.productId, newStock: product.stock });
//       } else {
//         console.log('Product not found for stock update during clear:', item.productId);
//       }
//     }
