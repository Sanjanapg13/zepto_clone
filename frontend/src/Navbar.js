...
//   // Check if the current route is admin-dashboard or vendor-dashboard
...
//   // Simplified Navbar for AdminDashboard and VendorDashboard
//   if (isDashboardRoute) {
//     return (
...
//             onClick={() => {
//               if (isSuperSaverOn) {
//                 // If currently on (slider on the right), toggle off and go to home page
//                 setIsSuperSaverOn(false);
//                 navigate('/');
//               } else {
//                 // If currently off (slider on the left), toggle on and go to deal-zone
