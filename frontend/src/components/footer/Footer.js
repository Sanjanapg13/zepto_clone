...
//           <a href="#" style={styles.link}>Yakult</a>|
//           <a href="#" style={styles.link}>My Muse</a>|
//           <a href="#" style={styles.link}>Aashirvaad Atta</a>|
//           <a href="#" style={styles.link}>Too Yumm</a>|
//           <a href="#" style={styles.link}>Lays</a>|
//           <a href="#" style={styles.link}>Figaro Olive Oil</a>|
//           <a href="#" style={styles.link}>Nandini Milk</a>|
//           <a href="#" style={styles.link}>Amul</a>|
//           <a href="#" style={styles.link}>Mother Dairy Near Me</a>|
//           <a href="#" style={styles.link}>Fortune Oil</a>
//         </div>
//         <div>
...
//             ['Masala & Dry Fruits', 'Cold Drinks & Juices', 'Biscuits', 'Electricals & Accessories'],
...
//           <li><a href="#" style={styles.link}>Delivery Areas</a></li>
//           <li><a href="#" style={styles.link}>Careers</a></li>
//           <li><a href="#" style={styles.link}>Customer Support</a></li>
//           <li><a href="#" style={styles.link}>Privacy Policy</a></li>
//           <li><a href="#" style={styles.link}>Terms of Use</a></li>
//           <li><a href="#" style={styles.link}>Responsible Disclosure Policy</a></li>
//           <li><a href="#" style={styles.link}>Mojo - a Zepto Blog</a></li>
//         </ul>

//         <div style={styles.appButtons}>
//           <a href="#"><img style={styles.appImage} src="https://imgs.search.brave.com/KxgTdA692UH8L4kZu6aXiOb_jRFkjMYfKrea9E9nNAY/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/cG5nbWFydC5jb20v/ZmlsZXMvMTAvR2V0/LUl0LU9uLUdvb2ds/ZS1QbGF5LVBORy1U/cmFuc3BhcmVudC1J/bWFnZS5wbmc" alt="Get it on play store" /></a>
//           <a href="#"><img style={styles.appImage} src="https://imgs.search.brave.com/zkbUGVgXn1M8tiHBbiwr2UTWR9JF2yfXDK_8aSFwz40/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9kZXZl/bG9wZXIuYXBwbGUu/Y29tL2Fzc2V0cy9l/bGVtZW50cy9iYWRn/ZXMvZG93bmxvYWQt/b24tdGhlLWFwcC1z/dG9yZS5zdmc" /></a>
//         </div>
//       </div>
//     </footer>
//   );
