...
//   const handleSeeAllHomeNeeds = (e) => {
//     e.preventDefault();
//     navigate('/products?category=HomeNeeds');
//   };

//   const handleSeeAllFashion = (e) => {
//     e.preventDefault();
...
//           /* Styled "Must have in your Household" and "Fashion Essentials" sections */
//           .household-section, .fashion-section {
//             background: #f8f4f1;
//             border-radius: 16px;
//             padding: 20px;
//             margin-top: 2rem;
//           }
//           .household-section .section-title, .fashion-section .section-title {
//             font-size: 20px;
//             font-weight: bold;
//             color: #333;
//             margin-bottom: 10px;
//           }
//           .household-section .see-all, .fashion-section .see-all {
//             font-size: 14px;
//             color: #ff2e63;
//             font-weight: 500;
//             text-decoration: none;
//           }
//           .household-section .product-row, .fashion-section .product-row {
//             display: flex;
//             overflow-x: auto;
//             gap: 15px;
//             padding: 10px 0;
...
//             -ms-overflow-style: none;
//           }
//           .household-section .product-row::-webkit-scrollbar, .fashion-section .product-row::-webkit-scrollbar {
//             display: none;
//           }
//           .household-section .product-card, .fashion-section .product-card {
//             background: #ffffff;
//             border-radius: 12px;
//             padding: 10px;
//             min-width: 140px;
...
//             position: relative;
//           }
//           .household-section .product-card img, .fashion-section .product-card img {
//             width: 100%;
//             border-radius: 10px;
//             height: 100px;
//             object-fit: cover;
//           }
//           .household-section .product-card strong, .fashion-section .product-card strong {
//             font-size: 13px;
//             font-weight: 500;
//             color: #333;
//             display: block;
//           }
//           .household-section .product-card .price, .fashion-section .product-card .price {
//             font-size: 12px;
//             color: #333;
//             margin-top: 5px;
//           }
//           .household-section .product-card .original-price, .fashion-section .product-card .original-price {
//             text-decoration: line-through;
//             color: #999;
//             font-size: 10px;
//             margin-left: 5px;
//           }
//           .household-section .product-card .add-btn, .fashion-section .product-card .add-btn {
//             background: #ff2e63;
//             color: white;
//             border: none;
//             padding: 4px 8px;
...
//             margin-top: 5px;
//           }
//           .household-section .product-card .add-btn:disabled, .fashion-section .product-card .add-btn:disabled {
//             background: #E2E8F0;
//             cursor: not-allowed;
//             color: #A0AEC0;
//           }
...
//                   <span style={{ textDecoration: 'line-through', color: '#aaa', fontSize: '10px' }}>
//                     ₹{product.mrp}
//                   </span>
//                 </div>
//               </div>
...
//           <h4 className="section-title">Must have in your Household</h4>
//           <a href="#" className="see-all" onClick={handleSeeAllHomeNeeds}>See All <span></span></a>
//         </div>
...
//         <div className="d-flex justify-content-between align-items-center mb-3">
//           <h4 className="section-title">Fashion Essentials</h4>
//           <a href="#" className="see-all" onClick={handleSeeAllFashion}>See All <span></span></a>
//         </div>
//         <div className="product-row">
